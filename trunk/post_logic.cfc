...
<cffunction access="package" output="false" returntype="string" name="displayPosts">
	...
	<cfset q_getPosts = obj_post_sql.getPosts(numberToGet=arguments.numberToGet)>
	<cfset obj_post_display = createObject("component","post_display")>	
	<cfsavecontent variable="s_displayPosts">
	<cfoutput>#obj_post_display.showPosts(postQuery=q_getPosts,userID=arguments.userID,showCount=arguments.showCount)#</cfoutput>
	</cfsavecontent>
...
<cffunction access="package" output="false" returntype="string" name="getSearch">
	...
	#obj_post_display.showPosts(postQuery=q_getPosts,userID=arguments.userID)#
	</cfoutput>
	</cfsavecontent>
...
<cffunction access="package" output="false" returntype="string" name="postInput">
	...
	<cfoutput>#obj_post_display.showPostInput(topicList=q_topics,postData=q_getPosts,userID=arguments.userID)#</cfoutput>
	</cfsavecontent>
...
<cffunction access="package" output="false" returntype="void" name="saveReply">
	...
	<cfset obj_post_sql = createObject("component","post_sql").init(dsn=module_dsn)>
	<cfif arguments.postID GT 0>
		<cfset x = obj_post_sql.insertReply(userID=arguments.userID,postID=arguments.postID,reply=arguments.reply)>
	<cfelse>
