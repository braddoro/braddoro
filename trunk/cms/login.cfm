...
<cfif field1 NEQ "" and field2 NEQ "">
	<cfset i_userID = createObject("component","cfc.auth_c").authenticate(loginName=form.field1,password=form.field2,remoteIP="#cgi.REMOTE_ADDR#",dsn="cmsdb",allowedAttempts=5,attemptInterval=2)>
	<cfif i_userID GT 0>
		<cfset session.publicID = createObject("component","cfc.auth_c").getUser(userID=i_userID,publicID="",dsn="cmsdb").publicID>
