<?php 
$PageID = 65;
$PageName="workitems.php";
$ListSP="usp_Select_WorkItems_All";
$SelectSP="usp_Select_WorkItem";
$UpdateSP="usp_Insert_WorkItem";
$SelectedID="WorkItemID";
$FieldString="WorkItemName";
$FieldString2="WorkItemMinutes";
$ViewString="Work Item Name";
$ViewString2="Work Minutes";
$SizeString2=5;
...
if (isset($_POST["Submit"])) {
	...
	$sql = $UpdateSP." '".sqlsafe($_POST["TheString"])."', ".$_POST["TheString2"].", '".$Active."'";
...
if (isset($CurrentID)) {
	...
	if ($CurrentID > 0) { 
		...
		while($row=odbc_fetch_array($rs)){
			...
			echo "</tr>".$g_break;
			echo "<tr>";
			echo "<td class='sideheader'>".$ViewString2."</td>";
			echo "<td class='formright'><input type='text' name='TheString2' id='TheString2' value='".$row[$FieldString2]."' size='".$SizeString2."' maxlength='".$SizeString2."'></td>";
			echo "</tr>".$g_break;
			echo "<tr>";
		...
		echo "<tr>";
		echo "<td class='sideheader'>".$ViewString2."</td>";
		echo "<td class='formright'><input type='text' name='TheString2' id='TheString2' value='' size='".$SizeString2."' maxlength='".$SizeString2."'></td>";
		echo "</tr>".$g_break;
