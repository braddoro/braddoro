<?php 
$PageID = 63;
$PageName="salarytypes.php";
$ListSP="usp_Select_SalaryTypes_All";
$SelectSP="usp_Select_SalaryType";
$UpdateSP="usp_Insert_SalaryType";
$SelectedID="SalaryTypeID";
$FieldString="SalaryType";
$ViewString="Salary Type";
$PageID = 33;
