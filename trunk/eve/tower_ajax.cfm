...
<cfcase value="silo">
	...
	<cfquery datasource="braddoro" name="q_reaction">
		...
		dateDiff(DATE_ADD(TR.lastEmptyDate, INTERVAL hoursToFill HOUR),TR.lastEmptyDate) as 'daysLeft'   
	...
	<cfsavecontent variable="_html">
		...
		<cfoutput query="q_reaction" group="owner">
			...
			<cfoutput>
				...
				<tr style="cursor:default;" title="click to view">
					<td style="padding-right:5px;" class="#s_class#"><img src="Button-Pause-16x16.png" border="0" height="#i_iconSize#" width="#i_iconSize#" title="Update silo empty date." onclick="js_silo('silo','#towerID#','#reactionID#');"></td>
