<?php 
$PageID = 59;
$PageName="numbertypes.php";
$ListSP="usp_Select_NumberTypes_All";
$SelectSP="usp_Select_NumberType";
$UpdateSP="usp_Insert_NumberType";
$SelectedID="NumberTypeID";
$FieldString="NumberType";
$ViewString="Number Type";
