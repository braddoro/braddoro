<?php 
$PageID = 45;
$PageName="addresstypes.php";
$ListSP="usp_Select_AddressTypes_All";
$SelectSP="usp_Select_AddressType";
$UpdateSP="usp_Insert_AddressType";
$SelectedID="AddressTypeID";
$FieldString="AddressType";
$ViewString="Address Type";
$PageID = 33;
