<?php 
$PageID = 58;
$PageName="maintenancetasks.php";
$ListSP="usp_Select_MaintenanceTasks_All";
$SelectSP="usp_Select_MaintenanceTask";
$UpdateSP="usp_Insert_MaintenanceTask";
$SelectedID="MaintenanceTaskID";
$FieldString="Task";
$ViewString="Maintenance Task";
