...
<cffunction access="package" output="false" returntype="String" name="showLogin">
	...
	<cfsavecontent variable="s_showLogin">
		...
		<input type="button" id="authenticateUser" name="authenticateUser" alt="log in" value="log in" title="log in" class="navButtons" onclick="js_buildRequest('authenticateUser','div_main',0);js_buildRequest('showBanner','div_banner',0);;js_buildRequest('showPosts','div_main',0);">
		</fieldset>
		</cfoutput>
	</cfsavecontent>
